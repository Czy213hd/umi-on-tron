...
It renames all the occurrences of legged_loco (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the legged_loco folder
        os.rename(
            os.path.join(root_dir_path, "exts", "legged_loco", "legged_loco"),
            os.path.join(root_dir_path, "exts", "legged_loco", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "legged_loco"), os.path.join(root_dir_path, "exts", new_name))
