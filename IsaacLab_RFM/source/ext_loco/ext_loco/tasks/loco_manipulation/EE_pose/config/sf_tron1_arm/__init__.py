...
gym.register(
    id="Template-Isaac-EEPose-Rough-Limx-SF-Tron1A-v0",
...
gym.register(
    id="Template-Isaac-EEPose-Rough-Limx-SF-Tron1A-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Template-Isaac-EEPose-Rough-Limx-SF-Tron1A-FPO-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": sf_tron1_arm_env_cfg.LimxEEposeRoughEnvCfg,
...
gym.register(
    id="Template-Isaac-EEPose-Rough-Limx-SF-Tron1A-FPO-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": sf_tron1_arm_env_cfg.LimxEEposeRoughEnvCfg_PLAY,
