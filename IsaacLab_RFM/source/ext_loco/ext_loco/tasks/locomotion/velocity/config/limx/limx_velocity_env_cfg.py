...
import ext_loco.tasks.locomotion.velocity.mdp as mdp

##
# Pre-defined configs
##
from isaaclab.terrains.config.rough import ROUGH_TERRAINS_CFG  # isort: skip
from ext_loco.assets.limx import LIMX_WF_TRON1A
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = LIMX_WF_TRON1A.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # sensors
...
class ActionsCfg:
    ...
    joint_vel = mdp.JointVelocityActionCfg(asset_name="robot", joint_names=["wheel_[RL]_Joint"], 
                                           scale=1.5, use_default_offset=True)
