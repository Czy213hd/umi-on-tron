...
private:
  ...
  // Debug: index -> URDF joint name mapped into jointData_.
  std::vector<std::string> jointNameByIndex_;

#ifdef USE_ARX5_SDK
  double arx5_gripper_pos_open_{0.085};
  double arx5_gripper_pos_close_{0.0};
  std::unique_ptr<Arx5SocketCanArm> arx5_arm_hw_;
#else
